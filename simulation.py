...
speeds = {'car': 2.25, 'bus': 1.8, 'truck': 1.8, 'rickshaw': 2, 'bike': 2.5,
          'ambulance': 2.5}  # average speeds of vehicles
...
vehicleCountCoods = [(480, 210), (880, 210), (880, 550), (480, 550), (480, 550)]
...
def setTime():
    ...
    greenTime = math.ceil(((noOfCars * carTime) + (noOfRickshaws * rickshawTime) + (noOfBuses * busTime) + (
                noOfTrucks * truckTime) + (noOfBikes * bikeTime) + (noOfAmbulance * ambulanceTime)) / (noOfLanes + 1))
